<template>
  <div class="relative w-full hero h-600">
        ...
        <div class="ml-4">
          ...
          <div class="mt-10">
            ...
            <div class="flex items-center mt-5">
              ...
              <button class="btn_sm">Lalitpur</button>
              <button class="btn_sm">Bhaktapur</button>
            </div>
          </div>
        </div>
      </div>
