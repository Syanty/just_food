<template>
  <div class="freshmart h-64">
    <div class="container-fluid pt-10 w-10/12 mx-auto">
      <h2 class="text-red-900 font-bold text-2xl">JUSTFOOD FRESHMART</h2>
      <h2 class="text-xl font-semibold">"Sale at best Price"</h2>
      <button class="btn_large mt-10">Discover Now</button>
    </div>
  </div>
</template>
<style scoped>
